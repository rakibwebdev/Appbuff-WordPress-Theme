...
class Xsprefix_Instagram extends WP_Widget
{
    function __construct() {

        $widget_opt = array(
            'classname'     => 'appbuff-widget',
            'description'   => 'appbuff instagrams'
        );
        
        parent::__construct('appbuff-instagram', esc_html__('appbuff instagram', 'appbuff'), $widget_opt);
    }
    ...
    function form($instance){
        ...
        $user_id = '';
        $media_count = 10;
        $title = esc_html__( 'Instagram', 'appbuff' );
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title:', 'appbuff' ); ?></label>
        ...
        <p>
            ...
            <?php esc_html__( 'Log in and get my Access Token and User ID' , 'appbuff' ); ?>
            </a>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'access_token' )); ?>"><?php esc_html__( 'Access token:' , 'appbuff' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user_id' )); ?>"><?php esc_html__( 'User ID:' , 'appbuff' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_count' )); ?>"><?php esc_html__( 'Count:' , 'appbuff' ); ?></label>
