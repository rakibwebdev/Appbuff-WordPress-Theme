 ...
 * twitter feed widget
 */
class Xsprefix_Twitter_Feed extends WP_Widget {

    function __construct() {
        $widget_opt = array(
            'classname'		 => 'appbuff-twitter-feed',
            'description'	 => esc_html__('Xsprefix twitter feed','appbuff')
        );

        parent::__construct( 'xs-twitter-feed', esc_html__( 'Xsprefix twitter feed', 'appbuff' ), $widget_opt );
    }
    ...
    function widget( $args, $instance ) {
        ...
        $username			 = '';
        $loading_text = esc_html__('Loading!','appbuff');
    ...
    function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Twitter feed', 'appbuff' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Username:', 'appbuff' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'loading_text' ) ); ?>"><?php esc_html_e( 'Loading text:', 'appbuff' ); ?></label>
