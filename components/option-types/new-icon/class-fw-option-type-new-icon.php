...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( HOSTINZA_INC . '/includes/option-types/new-icon/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'hostinza' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'hostinza' ),
					'hand'				 => esc_html__( 'Hand Icons', 'hostinza' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'hostinza' ),
					'gender'			 => esc_html__( 'Gender Icons', 'hostinza' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'hostinza' ),
					'payment'			 => esc_html__( 'Payment Icons', 'hostinza' ),
					'currency'			 => esc_html__( 'Currency Icons', 'hostinza' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'hostinza' ),
					'directional'		 => esc_html__( 'Directional Icons', 'hostinza' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'hostinza' ),
					'brand'				 => esc_html__( 'Brand Icons', 'hostinza' ),
					'medical'			 => esc_html__( 'Medical Icons', 'hostinza' ),
					'hostinza-icons'	 => esc_html__( 'hostinza Icons', 'hostinza' ),
				),
				'icons'				 => array(
					...
					//hostinza Icons
                    'icon icon-search-minus' => array('group' => 'hostinza-icons'),
                    'icon icon-search' => array('group' => 'hostinza-icons'),
                    'icon icon-down-arrow' => array('group' => 'hostinza-icons'),
                    'icon icon-up-arrow' => array('group' => 'hostinza-icons'),
                    'icon icon-right-arrow' => array('group' => 'hostinza-icons'),
                    'icon icon-left-arrows' => array('group' => 'hostinza-icons'),
                    'icon icon-heart' => array('group' => 'hostinza-icons'),
                    'icon icon-medical2' => array('group' => 'hostinza-icons'),
                    'icon icon-eye2' => array('group' => 'hostinza-icons'),
                    'icon icon-full-screen' => array('group' => 'hostinza-icons'),
                    'icon icon-shuffle-arrow' => array('group' => 'hostinza-icons'),
                    'icon icon-online-shopping-cart' => array('group' => 'hostinza-icons'),
                    'icon icon-shopping-cart2' => array('group' => 'hostinza-icons'),
                    'icon icon-apple-1' => array('group' => 'hostinza-icons'),
                    'icon icon-apple' => array('group' => 'hostinza-icons'),
                    'icon icon-watch' => array('group' => 'hostinza-icons'),
                    'icon icon-cogwheel' => array('group' => 'hostinza-icons'),
                    'icon icon-light-bulb' => array('group' => 'hostinza-icons'),
                    'icon icon-light-bulb-1' => array('group' => 'hostinza-icons'),
                    'icon icon-u-turn' => array('group' => 'hostinza-icons'),
                    'icon icon-medal' => array('group' => 'hostinza-icons'),
                    'icon icon-team-1' => array('group' => 'hostinza-icons'),
                    'icon icon-team2' => array('group' => 'hostinza-icons'),
                    'icon icon-team' => array('group' => 'hostinza-icons'),
                    'icon icon-tshirt' => array('group' => 'hostinza-icons'),
                    'icon icon-cancel' => array('group' => 'hostinza-icons'),
                    'icon icon-drink' => array('group' => 'hostinza-icons'),
                    'icon icon-home2' => array('group' => 'hostinza-icons'),
                    'icon icon-music' => array('group' => 'hostinza-icons'),
                    'icon icon-rich' => array('group' => 'hostinza-icons'),
                    'icon icon-brush' => array('group' => 'hostinza-icons'),
                    'icon icon-opposite-way' => array('group' => 'hostinza-icons'),
                    'icon icon-cloud-computing' => array('group' => 'hostinza-icons'),
                    'icon icon-technology-1' => array('group' => 'hostinza-icons'),
                    'icon icon-rotate' => array('group' => 'hostinza-icons'),
                    'icon icon-medical' => array('group' => 'hostinza-icons'),
                    'icon icon-flash-1' => array('group' => 'hostinza-icons'),
                    'icon icon-flash' => array('group' => 'hostinza-icons'),
                    'icon icon-hours-support' => array('group' => 'hostinza-icons'),
                    'icon icon-bag' => array('group' => 'hostinza-icons'),
                    'icon icon-photo-camera' => array('group' => 'hostinza-icons'),
                    'icon icon-school' => array('group' => 'hostinza-icons'),
                    'icon icon-settings' => array('group' => 'hostinza-icons'),
                    'icon icon-smartphone2' => array('group' => 'hostinza-icons'),
                    'icon icon-technology-12' => array('group' => 'hostinza-icons'),
                    'icon icon-tool' => array('group' => 'hostinza-icons'),
                    'icon icon-business2' => array('group' => 'hostinza-icons'),
                    'icon icon-star' => array('group' => 'hostinza-icons'),
                    'icon icon-star-1' => array('group' => 'hostinza-icons'),
                    'icon icon-favorite' => array('group' => 'hostinza-icons'),
                    'icon icon-valentines-heart' => array('group' => 'hostinza-icons'),
                    'icon icon-van-1' => array('group' => 'hostinza-icons'),
                    'icon icon-van' => array('group' => 'hostinza-icons'),
                    'icon icon-vegetables' => array('group' => 'hostinza-icons'),
                    'icon icon-women' => array('group' => 'hostinza-icons'),
                    'icon icon-left-arrow' => array('group' => 'hostinza-icons'),
                    'icon icon-vintage' => array('group' => 'hostinza-icons'),
                    'icon icon-up-arrow2' => array('group' => 'hostinza-icons'),
                    'icon icon-arrows' => array('group' => 'hostinza-icons'),
                    'icon icon-download-arrow' => array('group' => 'hostinza-icons'),
                    'icon icon-facebook' => array('group' => 'hostinza-icons'),
                    'icon icon-twitter' => array('group' => 'hostinza-icons'),
                    'icon icon-dribbble' => array('group' => 'hostinza-icons'),
                    'icon icon-linkedin' => array('group' => 'hostinza-icons'),
                    'icon icon-youtube' => array('group' => 'hostinza-icons'),
                    'icon icon-twitter3' => array('group' => 'hostinza-icons'),
                    'icon icon-pinterest' => array('group' => 'hostinza-icons'),
                    'icon icon-vimeo' => array('group' => 'hostinza-icons'),
                    'icon icon-soundcloud' => array('group' => 'hostinza-icons'),
                    'icon icon-youtube-v' => array('group' => 'hostinza-icons'),
                    'icon icon-behance' => array('group' => 'hostinza-icons'),
                    'icon icon-google-plus' => array('group' => 'hostinza-icons'),
                    'icon icon-instagram' => array('group' => 'hostinza-icons'),
                    'icon icon-double-left-chevron' => array('group' => 'hostinza-icons'),
                    'icon icon-double-angle-pointing-to-right' => array('group' => 'hostinza-icons'),
                    'icon icon-down-arrow2' => array('group' => 'hostinza-icons'),
                    'icon icon-arrow-point-to-down' => array('group' => 'hostinza-icons'),
                    'icon icon-play-button' => array('group' => 'hostinza-icons'),
                    'icon icon-minus' => array('group' => 'hostinza-icons'),
                    'icon icon-plus' => array('group' => 'hostinza-icons'),
                    'icon icon-tick' => array('group' => 'hostinza-icons'),
                    'icon icon-edit' => array('group' => 'hostinza-icons'),
                    'icon icon-reply' => array('group' => 'hostinza-icons'),
                    'icon icon-cogwheel-outline' => array('group' => 'hostinza-icons'),
                    'icon icon-symbol' => array('group' => 'hostinza-icons'),
                    'icon icon-calendar' => array('group' => 'hostinza-icons'),
                    'icon icon-shopping-cart' => array('group' => 'hostinza-icons'),
                    'icon icon-shopping-basket' => array('group' => 'hostinza-icons'),
                    'icon icon-users2' => array('group' => 'hostinza-icons'),
                    'icon icon-man' => array('group' => 'hostinza-icons'),
                    'icon icon-support' => array('group' => 'hostinza-icons'),
                    'icon icon-favorites' => array('group' => 'hostinza-icons'),
                    'icon icon-calendar3' => array('group' => 'hostinza-icons'),
                    'icon icon-paper-plane' => array('group' => 'hostinza-icons'),
                    'icon icon-placeholder' => array('group' => 'hostinza-icons'),
                    'icon icon-phone-call' => array('group' => 'hostinza-icons'),
                    'icon icon-newsletter' => array('group' => 'hostinza-icons'),
                    'icon icon-contact' => array('group' => 'hostinza-icons'),
                    'icon icon-email' => array('group' => 'hostinza-icons'),
                    'icon icon-envelope' => array('group' => 'hostinza-icons'),
                    'icon icon-internet' => array('group' => 'hostinza-icons'),
                    'icon icon-quote2' => array('group' => 'hostinza-icons'),
                    'icon icon-tools2' => array('group' => 'hostinza-icons'),
                    'icon icon-pie-chart2' => array('group' => 'hostinza-icons'),
                    'icon icon-diamond' => array('group' => 'hostinza-icons'),
                    'icon icon-like' => array('group' => 'hostinza-icons'),
                    'icon icon-deal' => array('group' => 'hostinza-icons'),
                    'icon icon-left-arrow2' => array('group' => 'hostinza-icons'),
                    'icon icon-quote22' => array('group' => 'hostinza-icons'),
                    'icon icon-right-arrow2' => array('group' => 'hostinza-icons'),
                    'icon icon-coins-2' => array('group' => 'hostinza-icons'),
                    'icon icon-commerce-2' => array('group' => 'hostinza-icons'),
                    'icon icon-monitor' => array('group' => 'hostinza-icons'),
                    'icon icon-business' => array('group' => 'hostinza-icons'),
                    'icon icon-graphic-2' => array('group' => 'hostinza-icons'),
                    'icon icon-commerce-1' => array('group' => 'hostinza-icons'),
                    'icon icon-hammer' => array('group' => 'hostinza-icons'),
                    'icon icon-justice-1' => array('group' => 'hostinza-icons'),
                    'icon icon-line' => array('group' => 'hostinza-icons'),
                    'icon icon-money-3' => array('group' => 'hostinza-icons'),
                    'icon icon-commerce' => array('group' => 'hostinza-icons'),
                    'icon icon-agenda' => array('group' => 'hostinza-icons'),
                    'icon icon-justice' => array('group' => 'hostinza-icons'),
                    'icon icon-technology' => array('group' => 'hostinza-icons'),
                    'icon icon-coins-1' => array('group' => 'hostinza-icons'),
                    'icon icon-bank' => array('group' => 'hostinza-icons'),
                    'icon icon-calculator' => array('group' => 'hostinza-icons'),
                    'icon icon-chart22' => array('group' => 'hostinza-icons'),
                    'icon icon-checked' => array('group' => 'hostinza-icons'),
                    'icon icon-clock3' => array('group' => 'hostinza-icons'),
                    'icon icon-comment' => array('group' => 'hostinza-icons'),
                    'icon icon-comments' => array('group' => 'hostinza-icons'),
                    'icon icon-consult' => array('group' => 'hostinza-icons'),
                    'icon icon-consut2' => array('group' => 'hostinza-icons'),
                    'icon icon-folder' => array('group' => 'hostinza-icons'),
                    'icon icon-invest' => array('group' => 'hostinza-icons'),
                    'icon icon-loan' => array('group' => 'hostinza-icons'),
                    'icon icon-map-marker2' => array('group' => 'hostinza-icons'),
                    'icon icon-mutual-fund' => array('group' => 'hostinza-icons'),
                    'icon icon-phone3' => array('group' => 'hostinza-icons'),
                    'icon icon-pie-chart22' => array('group' => 'hostinza-icons'),
                    'icon icon-play' => array('group' => 'hostinza-icons'),
                    'icon icon-savings' => array('group' => 'hostinza-icons'),
                    'icon icon-search3' => array('group' => 'hostinza-icons'),
                    'icon icon-tag' => array('group' => 'hostinza-icons'),
                    'icon icon-tags' => array('group' => 'hostinza-icons'),
                    'icon icon-vplay' => array('group' => 'hostinza-icons'),
                    'icon icon-mobile2' => array('group' => 'hostinza-icons'),
                    'icon icon-laptop2' => array('group' => 'hostinza-icons'),
                    'icon icon-desktop2' => array('group' => 'hostinza-icons'),
                    'icon icon-tablet2' => array('group' => 'hostinza-icons'),
                    'icon icon-phone2' => array('group' => 'hostinza-icons'),
                    'icon icon-document' => array('group' => 'hostinza-icons'),
                    'icon icon-documents' => array('group' => 'hostinza-icons'),
                    'icon icon-search2' => array('group' => 'hostinza-icons'),
                    'icon icon-clipboard2' => array('group' => 'hostinza-icons'),
                    'icon icon-newspaper' => array('group' => 'hostinza-icons'),
                    'icon icon-notebook' => array('group' => 'hostinza-icons'),
                    'icon icon-book-open' => array('group' => 'hostinza-icons'),
                    'icon icon-browser' => array('group' => 'hostinza-icons'),
                    'icon icon-calendar2' => array('group' => 'hostinza-icons'),
                    'icon icon-presentation' => array('group' => 'hostinza-icons'),
                    'icon icon-picture' => array('group' => 'hostinza-icons'),
                    'icon icon-pictures' => array('group' => 'hostinza-icons'),
                    'icon icon-video' => array('group' => 'hostinza-icons'),
                    'icon icon-camera2' => array('group' => 'hostinza-icons'),
                    'icon icon-printer' => array('group' => 'hostinza-icons'),
                    'icon icon-toolbox' => array('group' => 'hostinza-icons'),
                    'icon icon-briefcase2' => array('group' => 'hostinza-icons'),
                    'icon icon-wallet' => array('group' => 'hostinza-icons'),
                    'icon icon-gift2' => array('group' => 'hostinza-icons'),
                    'icon icon-bargraph' => array('group' => 'hostinza-icons'),
                    'icon icon-grid' => array('group' => 'hostinza-icons'),
                    'icon icon-expand2' => array('group' => 'hostinza-icons'),
                    'icon icon-focus' => array('group' => 'hostinza-icons'),
                    'icon icon-edit2' => array('group' => 'hostinza-icons'),
                    'icon icon-adjustments' => array('group' => 'hostinza-icons'),
                    'icon icon-ribbon' => array('group' => 'hostinza-icons'),
                    'icon icon-hourglass2' => array('group' => 'hostinza-icons'),
                    'icon icon-lock2' => array('group' => 'hostinza-icons'),
                    'icon icon-megaphone' => array('group' => 'hostinza-icons'),
                    'icon icon-shield2' => array('group' => 'hostinza-icons'),
                    'icon icon-trophy2' => array('group' => 'hostinza-icons'),
                    'icon icon-flag2' => array('group' => 'hostinza-icons'),
                    'icon icon-map2' => array('group' => 'hostinza-icons'),
                    'icon icon-puzzle' => array('group' => 'hostinza-icons'),
                    'icon icon-basket' => array('group' => 'hostinza-icons'),
                    'icon icon-envelope2' => array('group' => 'hostinza-icons'),
                    'icon icon-streetsign' => array('group' => 'hostinza-icons'),
                    'icon icon-telescope' => array('group' => 'hostinza-icons'),
                    'icon icon-gears2' => array('group' => 'hostinza-icons'),
                    'icon icon-key2' => array('group' => 'hostinza-icons'),
                    'icon icon-paperclip2' => array('group' => 'hostinza-icons'),
                    'icon icon-attachment' => array('group' => 'hostinza-icons'),
                    'icon icon-pricetags' => array('group' => 'hostinza-icons'),
                    'icon icon-lightbulb' => array('group' => 'hostinza-icons'),
                    'icon icon-layers' => array('group' => 'hostinza-icons'),
                    'icon icon-pencil2' => array('group' => 'hostinza-icons'),
                    'icon icon-tools' => array('group' => 'hostinza-icons'),
                    'icon icon-tools-2' => array('group' => 'hostinza-icons'),
                    'icon icon-scissors2' => array('group' => 'hostinza-icons'),
                    'icon icon-paintbrush' => array('group' => 'hostinza-icons'),
                    'icon icon-magnifying-glass' => array('group' => 'hostinza-icons'),
                    'icon icon-circle-compass' => array('group' => 'hostinza-icons'),
                    'icon icon-linegraph' => array('group' => 'hostinza-icons'),
                    'icon icon-mic' => array('group' => 'hostinza-icons'),
                    'icon icon-strategy' => array('group' => 'hostinza-icons'),
                    'icon icon-beaker' => array('group' => 'hostinza-icons'),
                    'icon icon-caution' => array('group' => 'hostinza-icons'),
                    'icon icon-recycle2' => array('group' => 'hostinza-icons'),
                    'icon icon-anchor2' => array('group' => 'hostinza-icons'),
                    'icon icon-profile-male' => array('group' => 'hostinza-icons'),
                    'icon icon-profile-female' => array('group' => 'hostinza-icons'),
                    'icon icon-bike' => array('group' => 'hostinza-icons'),
                    'icon icon-wine' => array('group' => 'hostinza-icons'),
                    'icon icon-hotairballoon' => array('group' => 'hostinza-icons'),
                    'icon icon-globe2' => array('group' => 'hostinza-icons'),
                    'icon icon-genius' => array('group' => 'hostinza-icons'),
                    'icon icon-map-pin2' => array('group' => 'hostinza-icons'),
                    'icon icon-dial' => array('group' => 'hostinza-icons'),
                    'icon icon-chat' => array('group' => 'hostinza-icons'),
                    'icon icon-heart2' => array('group' => 'hostinza-icons'),
                    'icon icon-cloud2' => array('group' => 'hostinza-icons'),
                    'icon icon-upload2' => array('group' => 'hostinza-icons'),
                    'icon icon-download2' => array('group' => 'hostinza-icons'),
                    'icon icon-target' => array('group' => 'hostinza-icons'),
                    'icon icon-hazardous' => array('group' => 'hostinza-icons'),
                    'icon icon-piechart' => array('group' => 'hostinza-icons'),
                    'icon icon-speedometer' => array('group' => 'hostinza-icons'),
                    'icon icon-global' => array('group' => 'hostinza-icons'),
                    'icon icon-compass2' => array('group' => 'hostinza-icons'),
                    'icon icon-lifesaver' => array('group' => 'hostinza-icons'),
                    'icon icon-clock' => array('group' => 'hostinza-icons'),
                    'icon icon-aperture' => array('group' => 'hostinza-icons'),
                    'icon icon-quote' => array('group' => 'hostinza-icons'),
                    'icon icon-scope' => array('group' => 'hostinza-icons'),
                    'icon icon-alarmclock' => array('group' => 'hostinza-icons'),
                    'icon icon-refresh2' => array('group' => 'hostinza-icons'),
                    'icon icon-happy' => array('group' => 'hostinza-icons'),
                    'icon icon-sad' => array('group' => 'hostinza-icons'),
                    'icon icon-facebook2' => array('group' => 'hostinza-icons'),
                    'icon icon-twitter2' => array('group' => 'hostinza-icons'),
                    'icon icon-googleplus' => array('group' => 'hostinza-icons'),
                    'icon icon-rss2' => array('group' => 'hostinza-icons'),
                    'icon icon-tumblr2' => array('group' => 'hostinza-icons'),
                    'icon icon-linkedin2' => array('group' => 'hostinza-icons'),
                    'icon icon-dribbble2' => array('group' => 'hostinza-icons'),
                    'icon icon-home' => array('group' => 'hostinza-icons'),
                    'icon icon-apartment' => array('group' => 'hostinza-icons'),
                    'icon icon-pencil' => array('group' => 'hostinza-icons'),
                    'icon icon-magic-wand' => array('group' => 'hostinza-icons'),
                    'icon icon-drop' => array('group' => 'hostinza-icons'),
                    'icon icon-lighter' => array('group' => 'hostinza-icons'),
                    'icon icon-poop' => array('group' => 'hostinza-icons'),
                    'icon icon-sun' => array('group' => 'hostinza-icons'),
                    'icon icon-moon' => array('group' => 'hostinza-icons'),
                    'icon icon-cloud' => array('group' => 'hostinza-icons'),
                    'icon icon-cloud-upload' => array('group' => 'hostinza-icons'),
                    'icon icon-cloud-download' => array('group' => 'hostinza-icons'),
                    'icon icon-cloud-sync' => array('group' => 'hostinza-icons'),
                    'icon icon-cloud-check' => array('group' => 'hostinza-icons'),
                    'icon icon-database' => array('group' => 'hostinza-icons'),
                    'icon icon-lock3' => array('group' => 'hostinza-icons'),
                    'icon icon-cog2' => array('group' => 'hostinza-icons'),
                    'icon icon-trash2' => array('group' => 'hostinza-icons'),
                    'icon icon-dice' => array('group' => 'hostinza-icons'),
                    'icon icon-heart3' => array('group' => 'hostinza-icons'),
                    'icon icon-star2' => array('group' => 'hostinza-icons'),
                    'icon icon-star-half2' => array('group' => 'hostinza-icons'),
                    'icon icon-star-empty' => array('group' => 'hostinza-icons'),
                    'icon icon-flag3' => array('group' => 'hostinza-icons'),
                    'icon icon-envelope3' => array('group' => 'hostinza-icons'),
                    'icon icon-paperclip' => array('group' => 'hostinza-icons'),
                    'icon icon-inbox' => array('group' => 'hostinza-icons'),
                    'icon icon-eye' => array('group' => 'hostinza-icons'),
                    'icon icon-printer2' => array('group' => 'hostinza-icons'),
                    'icon icon-file-empty' => array('group' => 'hostinza-icons'),
                    'icon icon-file-add' => array('group' => 'hostinza-icons'),
                    'icon icon-enter' => array('group' => 'hostinza-icons'),
                    'icon icon-exit' => array('group' => 'hostinza-icons'),
                    'icon icon-graduation-hat' => array('group' => 'hostinza-icons'),
                    'icon icon-license' => array('group' => 'hostinza-icons'),
                    'icon icon-music-note' => array('group' => 'hostinza-icons'),
                    'icon icon-film-play' => array('group' => 'hostinza-icons'),
                    'icon icon-camera-video' => array('group' => 'hostinza-icons'),
                    'icon icon-camera' => array('group' => 'hostinza-icons'),
                    'icon icon-picture2' => array('group' => 'hostinza-icons'),
                    'icon icon-book' => array('group' => 'hostinza-icons'),
                    'icon icon-bookmark' => array('group' => 'hostinza-icons'),
                    'icon icon-user2' => array('group' => 'hostinza-icons'),
                    'icon icon-users' => array('group' => 'hostinza-icons'),
                    'icon icon-shirt' => array('group' => 'hostinza-icons'),
                    'icon icon-store' => array('group' => 'hostinza-icons'),
                    'icon icon-cart' => array('group' => 'hostinza-icons'),
                    'icon icon-tag2' => array('group' => 'hostinza-icons'),
                    'icon icon-phone-handset' => array('group' => 'hostinza-icons'),
                    'icon icon-phone' => array('group' => 'hostinza-icons'),
                    'icon icon-pushpin' => array('group' => 'hostinza-icons'),
                    'icon icon-map-marker' => array('group' => 'hostinza-icons'),
                    'icon icon-map' => array('group' => 'hostinza-icons'),
                    'icon icon-location' => array('group' => 'hostinza-icons'),
                    'icon icon-calendar-full' => array('group' => 'hostinza-icons'),
                    'icon icon-keyboard' => array('group' => 'hostinza-icons'),
                    'icon icon-spell-check' => array('group' => 'hostinza-icons'),
                    'icon icon-screen' => array('group' => 'hostinza-icons'),
                    'icon icon-smartphone' => array('group' => 'hostinza-icons'),
                    'icon icon-tablet' => array('group' => 'hostinza-icons'),
                    'icon icon-laptop' => array('group' => 'hostinza-icons'),
                    'icon icon-laptop-phone' => array('group' => 'hostinza-icons'),
                    'icon icon-power-switch' => array('group' => 'hostinza-icons'),
                    'icon icon-bubble' => array('group' => 'hostinza-icons'),
                    'icon icon-heart-pulse' => array('group' => 'hostinza-icons'),
                    'icon icon-construction' => array('group' => 'hostinza-icons'),
                    'icon icon-pie-chart' => array('group' => 'hostinza-icons'),
                    'icon icon-chart-bars' => array('group' => 'hostinza-icons'),
                    'icon icon-gift' => array('group' => 'hostinza-icons'),
                    'icon icon-diamond2' => array('group' => 'hostinza-icons'),
                    'icon icon-dinner' => array('group' => 'hostinza-icons'),
                    'icon icon-coffee-cup' => array('group' => 'hostinza-icons'),
                    'icon icon-leaf' => array('group' => 'hostinza-icons'),
                    'icon icon-paw' => array('group' => 'hostinza-icons'),
                    'icon icon-rocket' => array('group' => 'hostinza-icons'),
                    'icon icon-briefcase' => array('group' => 'hostinza-icons'),
                    'icon icon-bus2' => array('group' => 'hostinza-icons'),
                    'icon icon-car2' => array('group' => 'hostinza-icons'),
                    'icon icon-train' => array('group' => 'hostinza-icons'),
                    'icon icon-bicycle2' => array('group' => 'hostinza-icons'),
                    'icon icon-wheelchair' => array('group' => 'hostinza-icons'),
                    'icon icon-select' => array('group' => 'hostinza-icons'),
                    'icon icon-earth' => array('group' => 'hostinza-icons'),
                    'icon icon-smile' => array('group' => 'hostinza-icons'),
                    'icon icon-sad2' => array('group' => 'hostinza-icons'),
                    'icon icon-neutral' => array('group' => 'hostinza-icons'),
                    'icon icon-mustache' => array('group' => 'hostinza-icons'),
                    'icon icon-alarm' => array('group' => 'hostinza-icons'),
                    'icon icon-bullhorn' => array('group' => 'hostinza-icons'),
                    'icon icon-volume-high' => array('group' => 'hostinza-icons'),
                    'icon icon-volume-medium' => array('group' => 'hostinza-icons'),
                    'icon icon-volume-low' => array('group' => 'hostinza-icons'),
                    'icon icon-volume' => array('group' => 'hostinza-icons'),
                    'icon icon-mic2' => array('group' => 'hostinza-icons'),
                    'icon icon-hourglass' => array('group' => 'hostinza-icons'),
                    'icon icon-undo' => array('group' => 'hostinza-icons'),
                    'icon icon-redo' => array('group' => 'hostinza-icons'),
                    'icon icon-sync' => array('group' => 'hostinza-icons'),
                    'icon icon-history' => array('group' => 'hostinza-icons'),
                    'icon icon-clock2' => array('group' => 'hostinza-icons'),
                    'icon icon-download3' => array('group' => 'hostinza-icons'),
                    'icon icon-upload' => array('group' => 'hostinza-icons'),
                    'icon icon-enter-down' => array('group' => 'hostinza-icons'),
                    'icon icon-exit-up' => array('group' => 'hostinza-icons'),
                    'icon icon-bug' => array('group' => 'hostinza-icons'),
                    'icon icon-code2' => array('group' => 'hostinza-icons'),
                    'icon icon-link' => array('group' => 'hostinza-icons'),
                    'icon icon-unlink' => array('group' => 'hostinza-icons'),
                    'icon icon-thumbs-up' => array('group' => 'hostinza-icons'),
                    'icon icon-thumbs-down' => array('group' => 'hostinza-icons'),
                    'icon icon-magnifier' => array('group' => 'hostinza-icons'),
                    'icon icon-cross' => array('group' => 'hostinza-icons'),
                    'icon icon-menu' => array('group' => 'hostinza-icons'),
                    'icon icon-list' => array('group' => 'hostinza-icons'),
                    'icon icon-chevron-up' => array('group' => 'hostinza-icons'),
                    'icon icon-chevron-down' => array('group' => 'hostinza-icons'),
                    'icon icon-chevron-left' => array('group' => 'hostinza-icons'),
                    'icon icon-chevron-right' => array('group' => 'hostinza-icons'),
                    'icon icon-arrow-up' => array('group' => 'hostinza-icons'),
                    'icon icon-arrow-down' => array('group' => 'hostinza-icons'),
                    'icon icon-arrow-left' => array('group' => 'hostinza-icons'),
                    'icon icon-arrow-right' => array('group' => 'hostinza-icons'),
                    'icon icon-move' => array('group' => 'hostinza-icons'),
                    'icon icon-warning' => array('group' => 'hostinza-icons'),
                    'icon icon-question-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-menu-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-checkmark-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-cross-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-plus-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-circle-minus' => array('group' => 'hostinza-icons'),
                    'icon icon-arrow-up-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-arrow-down-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-arrow-left-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-arrow-right-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-chevron-up-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-chevron-down-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-chevron-left-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-chevron-right-circle' => array('group' => 'hostinza-icons'),
                    'icon icon-crop' => array('group' => 'hostinza-icons'),
                    'icon icon-frame-expand' => array('group' => 'hostinza-icons'),
                    'icon icon-frame-contract' => array('group' => 'hostinza-icons'),
                    'icon icon-layers2' => array('group' => 'hostinza-icons'),
                    'icon icon-funnel' => array('group' => 'hostinza-icons'),
                    'icon icon-text-format' => array('group' => 'hostinza-icons'),
                    'icon icon-text-size' => array('group' => 'hostinza-icons'),
                    'icon icon-bold' => array('group' => 'hostinza-icons'),
                    'icon icon-italic' => array('group' => 'hostinza-icons'),
                    'icon icon-underline' => array('group' => 'hostinza-icons'),
                    'icon icon-strikethrough' => array('group' => 'hostinza-icons'),
                    'icon icon-highlight' => array('group' => 'hostinza-icons'),
                    'icon icon-text-align-left' => array('group' => 'hostinza-icons'),
                    'icon icon-text-align-center' => array('group' => 'hostinza-icons'),
                    'icon icon-text-align-right' => array('group' => 'hostinza-icons'),
                    'icon icon-text-align-justify' => array('group' => 'hostinza-icons'),
                    'icon icon-line-spacing' => array('group' => 'hostinza-icons'),
                    'icon icon-indent-increase' => array('group' => 'hostinza-icons'),
                    'icon icon-indent-decrease' => array('group' => 'hostinza-icons'),
                    'icon icon-page-break' => array('group' => 'hostinza-icons'),
                    'icon icon-hand' => array('group' => 'hostinza-icons'),
                    'icon icon-pointer-up' => array('group' => 'hostinza-icons'),
                    'icon icon-pointer-right' => array('group' => 'hostinza-icons'),
                    'icon icon-pointer-down' => array('group' => 'hostinza-icons'),
                    'icon icon-pointer-left' => array('group' => 'hostinza-icons'),
				),
			),
		);
	}
