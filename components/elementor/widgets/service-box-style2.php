...
class Appbuff_service_box_style2 extends Widget_Base {


  public $base;

    public function get_name() {
        return 'appbuff-service-box-style2';
    }

    public function get_title() {

        return esc_html__( 'Service Box Style 2', 'appbuff' );
    ...
    protected function render( ) { 
        ...
        ?>
            <div class="row upset ovr-bg1 ho-gdnt mt30">
